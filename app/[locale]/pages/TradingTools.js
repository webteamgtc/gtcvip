...
const TradingTools = () => {
  return (
    <section className="py-14 md:py-20 2xl:py-28">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">

          {/* Tool 1: Margin Calculator */}
          <div>
            <h2 className="HeadingH2 text-lg md:text-2xl text-left dark:text-white">Margin Calculator</h2>
            <iframe
          ...
          <div>
            <h2 className="HeadingH2 text-lg md:text-2xl text-left dark:text-white">Technical Summary</h2>
            <iframe
    ...
    {/* Tool 4: Forex Cross Rates */}
          <div>
            <h2 className="HeadingH2 text-lg md:text-2xl text-left dark:text-white mb-4">Economic Calendar</h2>
  <iframe
