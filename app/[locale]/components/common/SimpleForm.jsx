...
const SimpleForm = ({title, subtitle}) => {
  ...
  return (
    <div className="simple-form bg-[#f2f2f2] border border-gray-300 border-opacity-50 p-5 w-full rounded-lg md:w-full lg:w-96" id="register">
        ...
        originCountry === 'AE' ? (
          ...
          <form onSubmit={formik.handleSubmit} className="py-3">
            ...
            <button
              ...
              className="bg-secondary text-center w-full py-3 text-primary" type="submit">
              {loading ? <p> {t("sending")}</p> : <p>{t("submit")}</p>}
            </button>
          </form>
        )
