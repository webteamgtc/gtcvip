            ...
            <form onSubmit={formik.handleSubmit} className="space-y-4 account">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 ">
                <div className="flex flex-col">
                  ...
                  <input
                    className={`bg-primary text-white placeholder:text-white py-2 px-4 capitalize rounded-[3px] ${formik.touched.first_name && formik.errors.first_name
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    className={`bg-primary text-white placeholder:text-white capitalize py-2 px-4 rounded-[3px] ${formik.touched.last_name && formik.errors.last_name
                      ? "border-2 border-red-600"
                      : ""
                      } `}
                    type="text"
              ...
              <div className="grid grid-cols-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >{sendPhoneOtpLoading ? <span className="text-xs flex gap-2 justify-center items-center"><ClockLoader loading={sendPhoneOtpLoading} color="#2C6390" size={20} cssOverride={true} /> <span>Sending</span> </span> : <span>Send OTP</span>}
                  </button>
                </div>
              </div>
              <div className={`items-center gap-2 py-3 ${showPhoneOtpVerify ? `flex` : `hidden`}`}>
                ...
                />
                <button
                  className="bg-secondary text-primary text-center text-md font-semibold w-[30%] py-[9px] rounded hover:bg-primary hover:text-secondary hover:border-2 border-secondary border-2 transition-colors duration-300"
                  type="button"
                  onClick={verifyPhoneOtp}
                  disabled={disableVerifyPhoneOtpBtn}
                >{isPhoneVerified ? <span className="text-green-600 flex text-center justify-center items-center"><TiTick color="green" size={25} /> <span>Verified</span></span> : <p>Verify OTP</p>}</button>
              </div>
              <div className="grid grid-cols-1">
                <div className="flex flex-col">
                  <label
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      className={`bg-primary text-white placeholder:text-white py-2 px-4 rounded-[3px] w-full ${formik.touched.email && formik.errors.email
                        ? "border-2 border-red-600"
                        : ""
                        }`}
                      type="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div className="flex flex-col w-full">
                  ...
                  <input
                    className={`bg-primary w-full text-white placeholder:text-white py-2 px-4 rounded-[3px] custom_appearance ${formik.touched.date_of_birth && formik.errors.date_of_birth
                      ? "border-2 border-red-600"
                      : ""
                      }`}
                    name="date_of_birth"
                ...
                <div className="flex flex-col">
                  ...
                  <select
                    className={`bg-primary text-white placeholder:text-white capitalize pt-[12px] pb-[0.5rem] px-4 rounded-[3px] ${formik.touched.platform && formik.errors.platform
                      ? "border-2 border-red-600"
                      : ""
                      }`}
                    name="platform"
              ...
              <div className="grid grid-cols-1">
                <div className="flex flex-col">
                  ...
                  <select
                    className={`bg-primary text-white placeholder:text-white capitalize  py-2 px-4 rounded-[3px] ${formik.touched.country && formik.errors.country
                      ? "border-2 border-red-600"
                      : ""
                      }`}
                    name="country"
              ...
              <div className="text-center">
                <button
                  ...
                  type="submit"
                  className="text-secondary font-semibold cursor-pointer py-2 px-4 border border-secondary bg-primary hover:text-white"
                >
            ...
            <form onSubmit={formik.handleSubmit} className="space-y-4 account">
              ...
              <div className="grid grid-cols-1">
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      className={`bg-primary text-white placeholder:text-white py-2 px-4 rounded-[3px] w-[70%] ${formik.touched.email && formik.errors.email
                        ? "border-2 border-red-600"
                        : ""
                        }`}
                      type="email"
                    ...
                    >{sendEmailOtpLoading ? <span className="text-xs flex gap-2 justify-center items-center"><ClockLoader loading={sendEmailOtpLoading} color="#2C6390" size={20} cssOverride={true} /> <span>Sending</span> </span> : <span>Send OTP</span>}
                    </button>
                  </div>
                </div>
              </div>
